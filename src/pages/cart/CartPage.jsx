                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-gray-100 bg-amber-600 border border-transparent dark:border-gray-700 hover:border-amber-500 hover:text-amber-700 hover:bg-amber-100 rounded-xl"
                                    >
                                        Buy now
                                    </button>
                                </div>
